...
public class CartServiceImpl extends ServiceImpl<CartMapper, Cart> implements ICartService {
    ...
    // @autowired -> 创建constructor(@RequiredArgsConstructor)
...
//        ServiceInstance instance = instances.get(RandomUtil.randomInt(instances.size()));
        ...
        //利用RestTemplate发起http请求，得到http相应
//        ResponseEntity<List<ItemDTO>> responses = restTemplate.exchange(
...
//            return; //查询失败，直接返回
//        }
//        List<ItemDTO> items = responses.getBody();
